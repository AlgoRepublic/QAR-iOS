...
//    ScannedNoteViewController* controller = [self.storyboard instantiateViewControllerWithIdentifier:@"ScannedNoteViewController"];
//    UINavigationController *navController= [[UINavigationController alloc]initWithRootViewController:controller];
//    [navController.navigationBar setTranslucent:NO];
//    [controller setPrevNoteString:scanString];
