...
#define kFTToastDefaultFont                     [UIFont systemFontOfSize:60]
...
- (void)adjustIndicatorFrame
{
    ...
    int height = 200;
    [self.toastView setFrame:CGRectMake(30/2, (kFTScreenHeight-height)/2 , kFTScreenWidth-30, height)];
...
- (void)showToastMessage:(NSString *)toastMessage withStyle:(UIBlurEffectStyle)style
{
    ...
    CGRect rect = CGRectMake(0, 0, kFTScreenWidth-30, 200);
