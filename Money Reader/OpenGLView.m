...
- (id)initWithFrame:(CGRect)frame
{
    ...
    [self bindDrawable];
    /*Notification observer for Real or Fake Notification */
    //[[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(imageCodeScanedNotificationReceived:) name:@"noteDetected" object:nil];
